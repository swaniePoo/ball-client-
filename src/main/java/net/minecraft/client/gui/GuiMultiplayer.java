...
import viamcp.gui.VersionSlider;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public static void currentServer(ServerData currentServer) {
        GuiMultiplayer.currentServer = currentServer;
    }
    ...
    public void createButtons()
    {
        ...
        this.buttonList.add(new VersionSlider(420, 5, 38, 110, 20));
        this.buttonList.add(new GuiButton(99, 5, 59, 110, 20, "pls fucking kill me"));
            ...
            switch(button.id){
                ...
                case 99:{
                    for(Module module : Client.INSTANCE.getModuleRepository().modules()){
                        if(module.toggled() && module.getClass() != OverlayModule.class) module.toggle();
                    }
                    break;
                }
            }
