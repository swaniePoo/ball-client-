...
import me.dinozoid.strife.module.implementations.player.ChestStealerModule;
...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (Client.INSTANCE.getModuleRepository().moduleBy(ChestStealerModule.class).toggled() && this instanceof GuiChest && ChestStealerModule.silentProperty().getValue()) {
            return;
        }
...
//        PlayerUtil.sendMessage(serverTransactionId + " " + inventorySlots.getTransactionID());
        String text = (synchronizedTransactions ? "\u00A72Inventory synchronized" : "\u00A7cInventory desynchronized") + " (" + inventorySlots.getTransactionID() + ":" + serverTransactionId + ")";
        fontRendererObj.drawStringWithShadow(text, width / 2f - fontRendererObj.getStringWidth(text) / 2f, guiTop - fontRendererObj.FONT_HEIGHT * 2, -1);
