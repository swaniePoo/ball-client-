...
import me.dinozoid.strife.module.implementations.visuals.SessionInfoModule;
...
public class GuiChat extends GuiScreen
{
    ...
    {
        scoreboardModule.onMouseRelease(0, 0, 0);
        sessionInfoModule.onMouseRelease(0, 0, 0);
        overlayModule.onMouseRelease(0, 0, 0);
        killAuraModule.onMouseRelease(0, 0, 0);
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        DragManager.draggables.values().forEach(dragging -> {
            if (dragging.getModule().toggled()) {
                if (dragging.getModule().equals(overlayModule)) {
                    dragging.onClickArraylist(overlayModule, mouseX, mouseY, mouseButton);
                } else {
        ...
        scoreboardModule.onMouseClick(mouseX, mouseY, mouseButton);
        sessionInfoModule.onMouseClick(mouseX, mouseY, mouseButton);
        overlayModule.onMouseClick(mouseX, mouseY, mouseButton);
        killAuraModule.onMouseClick(mouseX, mouseY, mouseButton);
        if (mouseButton == 0)
        {
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state) {
        ...
        scoreboardModule.onMouseRelease(mouseX, mouseY, state);
        sessionInfoModule.onMouseRelease(mouseX, mouseY, state);
        overlayModule.onMouseRelease(mouseX, mouseY, state);
        killAuraModule.onMouseRelease(mouseX, mouseY, state);
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        DragManager.draggables.values().forEach(dragging -> {
            if (dragging.getModule().toggled()) {
                if (dragging.getModule().equals(overlayModule)) {
                    dragging.onDrawArraylist(overlayModule, mouseX, mouseY);
                } else {
        ...
        scoreboardModule.draw(mouseX, mouseY, partialTicks);
        sessionInfoModule.draw(mouseX, mouseY, partialTicks);
        overlayModule.draw(mouseX, mouseY, partialTicks);
        killAuraModule.draw(mouseX, mouseY, partialTicks);
