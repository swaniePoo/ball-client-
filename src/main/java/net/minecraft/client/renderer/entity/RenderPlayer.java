...
//            GlowESPModule glowESPModule = GlowESPModule.instance();
//            if(glowESPModule.toggled()) {
//                double finalD = d0;
//                glowESPModule.drawPlayer(() -> {
//                    super.doRender(entity, x, finalD, z, entityYaw, partialTicks);
//                });
//            }
        }
    }
