...
public class RenderManager {
    ...
    {
        return this.renderEntityStatic(entityIn, partialTicks, false, true);
    }

    public boolean renderEntitySimpleNoShadow(Entity entityIn, float partialTicks)
    {
        return this.renderEntityStatic(entityIn, partialTicks, false, false);
    }
    ...
    public void renderEntityStaticNoShadow(Entity entity, float partialTicks, boolean p_147936_3_) {
        ...
        double d0 = RenderUtil.interpolate(entity.posX, entity.lastTickPosX, partialTicks);
        double d1 = RenderUtil.interpolate(entity.posY, entity.lastTickPosY, partialTicks);
        double d2 = RenderUtil.interpolate(entity.posZ, entity.lastTickPosZ, partialTicks);
        float f = RenderUtil.interpolateFloat(entity.rotationYaw, entity.prevRotationYaw, partialTicks);
    ...
    public boolean renderEntityStatic(Entity entity, float partialTicks, boolean hideDebugBox, boolean shadow)
    {
        if (entity.ticksExisted == 0)
        {
            entity.lastTickPosX = entity.posX;
        ...
        OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, (float)j / 1.0F, (float)k / 1.0F);
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        return this.doRenderEntity(entity, d0 - this.renderPosX, d1 - this.renderPosY, d2 - this.renderPosZ, f, partialTicks, hideDebugBox, shadow);
    }
    ...
    {
        return this.doRenderEntity(entityIn, x, y, z, entityYaw, partialTicks, false, true);
    }
    ...
    public boolean doRenderEntity(Entity entity, double x, double y, double z, float entityYaw, float partialTicks, boolean hideDebugBox, boolean shadow)
    {
        Render<Entity> render = null;
