...
import me.dinozoid.strife.module.implementations.visuals.NoHurtCamModule;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (Client.INSTANCE.getModuleRepository().moduleBy(NoHurtCamModule.class).toggled()) return;
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        Client.INSTANCE.getEventBus().post(new RenderPlayerShaderEvent(partialTicks));
