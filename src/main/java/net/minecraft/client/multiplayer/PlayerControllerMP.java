...
import me.dinozoid.strife.event.implementations.player.DamageBlockEvent;
...
public class PlayerControllerMP
{
    ...
    {
        final DamageBlockEvent damageBlockEvent = new DamageBlockEvent(posBlock, directionFacing);
        Client.INSTANCE.getEventBus().post(damageBlockEvent);
    ...
    {
        // FIND ME :: GetClientSideCurrentSlotEvent
        final EAGames event = new EAGames(this.mc.thePlayer.inventory.currentItem);
...
//        System.out.println("held: " + i);
    ...
    public ItemStack windowClick(int windowId, int slotId, int mouseButtonClicked, int mode, EntityPlayer playerIn)
    {
        if (playerIn.equals(mc.thePlayer))
            Client.INSTANCE.getEventBus().post(new WindowClickEvent(windowId, slotId, mouseButtonClicked, mode));
