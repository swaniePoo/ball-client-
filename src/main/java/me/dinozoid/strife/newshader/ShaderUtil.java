package me.dinozoid.strife.newshader;
...
public class ShaderUtil extends MinecraftUtil {
        ...
        try {
            ...
            switch (fragmentShaderLoc) {
                ...
                case "roundedRectGradient":
                    ...
                    break;
                default:
                    fragmentShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation("strife/shaders/" + fragmentShaderLoc)).getInputStream(), GL_FRAGMENT_SHADER);
                    break;
            }
            glAttachShader(program, fragmentShaderID);

            int vertexShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation("strife/shaders/" + vertexShaderLoc)).getInputStream(), GL_VERTEX_SHADER);
    ...
    public ShaderUtil(String fragmentShaderLoc) {
        this(fragmentShaderLoc, "vertex/vertex.vert");
    }
