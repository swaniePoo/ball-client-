...
public class AccountInfo extends MinecraftUtil {
    ...
    private AccountStatus hypixelBanned = AccountStatus.UNKNOWN, mineplexBanned = AccountStatus.UNKNOWN;
    ...
    public CompletableFuture<Boolean> parse() {
        ...
        if (username != null) {
            PlayerUtil.getUUIDString(username).whenCompleteAsync((uuid, throwable) -> {
                this.uuid = uuid;
